...
def get_board_substrate(board, colors, defs, holes, back, silk):
    """
...
def main():
    ...
    board_cont.append(get_board_substrate(board, style, defs, not args.no_drillholes, args.back, not args.no_silk))
    if args.vcuts:
